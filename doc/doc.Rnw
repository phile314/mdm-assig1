...
% TODO Should I describe also grow and classify?
...
nmins <- c(c(0,1,2,3,4,5,6,8,10,15), seq(20, 40, 10), seq(50, 300, 30))
minleafs <- c(0:9, c(10,12,15), seq(20, 40, 10), seq(50, 300, 30))
ps_pars <- list()
